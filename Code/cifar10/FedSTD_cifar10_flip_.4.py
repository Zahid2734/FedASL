...
beta= .2
client_percent= .3
file_name = "../../Data/cifar10/Dataset0.4_1_100_flip_cifar10.pkl"
...
save_file_name= f'../../Data/cifar10/flipping/FedSTD_0.4_1_{client_percent}_{num_client}_{num_epochs}_{alpha}_{beta}_flip_cifar10.pkl'
