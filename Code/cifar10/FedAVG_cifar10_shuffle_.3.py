...
GLobal_accuracy,Client_accuracy, client_weight, taken_client = FedAVG_algo_cifar10(num_epochs, num_client, clients_batched,x_test,y_test, client_percent)

sample_list=[GLobal_accuracy,Client_accuracy, taken_client, bad_client]
save_file_name= f'../../Data/cifar10/shuffling/FedAVG_0.2_shuffle_cifar10_1.pkl'
