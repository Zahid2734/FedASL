...
beta= .2
client_percent= .3
file_name = "../../Data/cifar10/Dataset100_clean_cifar10.pkl"
...
save_file_name= f'../../Data/cifar10/clean/FedSTD_{client_percent}_{num_client}_{num_epochs}_{alpha}_{beta}_clean_cifar10.pkl'
