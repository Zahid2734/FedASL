...
beta= .2
client_percent= .3
file_name = "../../Data/cifar10/Dataset0.1_1_100_noise_cifar10.pkl"
...
save_file_name= f'../../Data/cifar10/noisy/FedSTD_0.1_1_{client_percent}_{num_client}_{num_epochs}_{alpha}_{beta}_noise_cifar10.pkl'
