...
beta= .2
client_percent= .3
file_name = "../../Data/cifar10/Dataset0.1_1_100_shuffle_cifar10.pkl"
...
save_file_name= f'../../Data/cifar10/shuffling/FedSTD_0.1_1_{client_percent}_{num_client}_{num_epochs}_{alpha}_{beta}_shuffle_cifar10.pkl'
