...
data1= '../../Data/mnist/noisy/FedAVG_0.3_1_0.3_100_200_noise_mnist.pkl'
FedAVG_3= open_file(data1)

data2= '../../Data/mnist/noisy/FedSTD_0.3_1_0.3_100_200_0.9_0.2_noise_mnist.pkl'
FedSTD_3= open_file(data2)

data3= '../../Data/mnist/noisy/FedAVG_0.1_1_0.3_100_200_noise_mnist.pkl'
FedAVG_1= open_file(data3)

data4='../../Data/mnist/noisy/FedSTD_0.1_1_0.3_100_200_1_0.2_noise_mnist.pkl'
FedSTD_1= open_file(data4)

data5= '../../Data/mnist/noisy/FedAVG_0.4_1_0.3_100_200_noise_mnist.pkl'
FedAVG_4= open_file(data5)

data6= '../../Data/mnist/noisy/FedSTD_0.4_1_0.3_100_200_0.7_0.2_noise_mnist.pkl'
FedSTD_4= open_file(data6)

data7= '../../Data/mnist/noisy/median_0.3_1_0.3_100_200_noise_mnist.pkl'
...
plt.show
# plt.savefig('../../Figures/mnist/mnist_noisy.pdf', bbox_inches='tight')
