...
data3= '../../Data/cifar10/flipping/FedAVG_0.1_1_0.3_100_200_flip_cifar10.pkl'
FedAVG_1= open_file(data3)

data4= '../../Data/cifar10/flipping/FedSTD_0.1_1_0.3_100_200_1_0.2_flip_cifar10.pkl'
FedSTD_1= open_file(data4)

data5= '../../Data/cifar10/flipping/FedAVG_0.4_1_0.3_100_200_flip_cifar10.pkl'
FedAVG_4= open_file(data5)

data6= '../../Data/cifar10/flipping/FedSTD_0.4_1_0.3_100_200_0.7_0.2_flip_cifar10.pkl'
FedSTD_4= open_file(data6)

data7= '../../Data/cifar10/flipping/median_0.3_1_0.3_100_200_flip_cifar10.pkl'
FedPA_3= open_file(data7)

data8= '../../Data/cifar10/flipping/trimmed_mean_0.3_1_0.3_100_200_flip_cifar10.pkl'
...
plt.show
# plt.savefig('../../Figures/cifar10/cifar10_flipping.pdf', bbox_inches='tight')
