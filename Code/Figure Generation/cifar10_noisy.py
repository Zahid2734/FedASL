...
data2= '../../Data/cifar10/noisy/FedSTD_0.3_1_0.3_100_200_0.9_0.2_noise_cifar10.pkl'
FedSTD_3= open_file(data2)

data3= '../../Data/cifar10/noisy/FedAVG_0.1_1_0.3_100_200_noise_cifar10.pkl'
FedAVG_1= open_file(data3)

data4= '../../Data/cifar10/noisy/FedSTD_0.1_1_0.3_100_200_1_0.2_noise_cifar10.pkl'
FedSTD_1= open_file(data4)

data5= '../../Data/cifar10/noisy/FedAVG_0.4_1_0.3_100_200_noise_cifar10.pkl'
FedAVG_4= open_file(data5)

data6= '../../Data/cifar10/noisy/FedSTD_0.4_1_0.3_100_200_0.7_0.2_noise_cifar10.pkl'
FedSTD_4= open_file(data6)

data7= '../../Data/cifar10/noisy/median_0.3_1_0.3_100_200_noise_cifar10.pkl'
FedPA_3= open_file(data7)

data8= '../../Data/cifar10/noisy/trimmed_mean_0.3_1_0.3_100_200_noise_cifar10.pkl'
...
plt.show
# plt.savefig('../../Figures/cifar10/cifar10_noisy.pdf', bbox_inches='tight')
