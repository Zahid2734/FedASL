...
data2= '../../Data/Femnist/flipping/FedSTD_0.3_1_3000_250_0.2_0.1_flip_Femnist.pkl'
FedSTD_3= open_file(data2)

data3= '../../Data/Femnist/flipping/FedAVG_0.1_1_3000_250_flip_Femnist.pkl'
FedAVG_1= open_file(data3)

data4='../../Data/Femnist/flipping/FedSTD_0.1_1_3000_250_1_0.2_flip_Femnist.pkl'
FedSTD_1= open_file(data4)

data5= '../../Data/Femnist/flipping/FedAVG_0.4_1_3000_250_flip_Femnist.pkl'
FedAVG_4= open_file(data5)

data6= '../../Data/Femnist/flipping/FedSTD_0.4_1_3000_250_0.5_0.2_flip_Femnist.pkl'
FedSTD_4= open_file(data6)

data7= '../../Data/Femnist/flipping/median_0.3_1_3000_250_flip_Femnist.pkl'
FedPA_4_2= open_file(data7)

data8= '../../Data/Femnist/flipping/trimmed_mean_0.3_1_3000_250_flip_Femnist.pkl'
FedPA_4= open_file(data8)


plt.figure(figsize=(40, 12))
plt.grid(zorder=1, color='black', linestyle='--', alpha=.5)
plt.subplot(1, 3, 1)
...
plt.show
# plt.savefig('../../Figures/femnist/femnist_flipping_3000.pdf', bbox_inches='tight')
