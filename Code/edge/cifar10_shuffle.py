...
data5= '../../Data/cifar10/shuffling/table/FedAVG_0.3_1_0.3_100_200_shuffle_cifar10.pkl'
FedAVG= open_file(data5)

data6= '../../Data/cifar10/shuffling/table/FedSTD_0.3_1_0.3_100_200_0.9_0.2_shuffle_cifar10.pkl'
FedSTD= open_file(data6)

data7= '../../Data/cifar10/shuffling/table/FedSTD_loss_0.3_1_0.3_100_200_0.9_0.2_shuffle_cifar10.pkl'
FedSTD_loss= open_file(data7)

data8= '../../Data/cifar10/shuffling/table/median_0.3_1_0.3_100_200_shuffle_cifar10.pkl'
median= open_file(data8)

data9= '../../Data/cifar10/shuffling/table/trimmed_mean_0.3_1_0.3_100_200_shuffle_cifar10.pkl'
TM= open_file(data9)
...
plt.ylim(0, 75)
plt.legend(loc=4,  handlelength=1, ncol=1,fontsize=32,
...
plt.show
plt.savefig('../../Figures/edge/power point/cifar10_shuffle.png', bbox_inches='tight')
