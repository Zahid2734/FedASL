...
data5= '../../Data/mnist/flipping/table/FedAVG_0.3_1_0.3_100_200_flip_mnist.pkl'
FedAVG= open_file(data5)

data6= '../../Data/mnist/flipping/table/FedSTD_0.3_1_0.3_100_200_0.9_0.2_flip_mnist.pkl'
FedSTD= open_file(data6)

data7= '../../Data/mnist/flipping/table/FedSTD_loss_0.3_1_0.3_100_200_0.9_0.2_flip_mnist.pkl'
FedSTD_loss= open_file(data7)

data8= '../../Data/mnist/flipping/table/median_0.3_1_0.3_100_200_flip_mnist.pkl'
median= open_file(data8)

data9= '../../Data/mnist/flipping/table/trimmed_mean_0.3_1_0.3_100_200_flip_mnist.pkl'
TM= open_file(data9)
...
plt.show
plt.savefig('../../Figures/edge/power point/mnist_flip.png', bbox_inches='tight')
