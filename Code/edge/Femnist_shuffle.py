...
data5= '../../Data/Femnist/Shuffling/table/FedAVG_0.3_1_3000_250_shuffle_Femnist.pkl'
FedAVG= open_file(data5)

data6= '../../Data/Femnist/Shuffling/table/FedSTD_0.3_1_3000_250_0.7_0.2_shuffle_Femnist.pkl'
FedSTD= open_file(data6)

data7= '../../Data/Femnist/Shuffling/table/FedSTD_loss_0.3_1_3000_250_0.7_0.2_shuffle_Femnist.pkl'
FedSTD_loss= open_file(data7)

data8= '../../Data/Femnist/Shuffling/table/median_0.3_1_3000_250_shuffle_Femnist.pkl'
median= open_file(data8)

data9= '../../Data/Femnist/Shuffling/table/trimmed_mean_0.3_1_3000_250_shuffle_Femnist.pkl'
TM= open_file(data9)
...
plt.show
plt.savefig('../../Figures/edge/power point/Femnist_shuffle.png', bbox_inches='tight')
