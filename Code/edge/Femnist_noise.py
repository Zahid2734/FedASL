...
data5= '../../Data/Femnist/Noisy/table/FedAVG_0.3_1_3000_250_noise_Femnist.pkl'
FedAVG= open_file(data5)

data6= '../../Data/Femnist/Noisy/table/FedSTD_0.3_1_3000_250_0.7_0.2_noise_Femnist.pkl'
FedSTD= open_file(data6)

data7= '../../Data/Femnist/Noisy/table/FedSTD_loss_0.3_1_3000_250_0.7_0.2_noise_Femnist.pkl'
FedSTD_loss= open_file(data7)

data8= '../../Data/Femnist/Noisy/table/median_0.3_1_3000_250_noise_Femnist.pkl'
median= open_file(data8)

data9= '../../Data/Femnist/Noisy/table/trimmed_mean_0.3_1_3000_250_noise_Femnist.pkl'
TM= open_file(data9)
...
plt.show
plt.savefig('../../Figures/edge/power point/Femnist_noise.png', bbox_inches='tight')
