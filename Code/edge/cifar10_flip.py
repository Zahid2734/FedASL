...
data5= '../../Data/cifar10/flipping/table/FedAVG_0.3_1_0.3_100_200_flip_cifar10.pkl'
FedAVG= open_file(data5)

data6= '../../Data/cifar10/flipping/table/FedSTD_0.3_1_0.3_100_200_0.9_0.2_flip_cifar10.pkl'
...
data8= '../../Data/cifar10/flipping/table/median_0.3_1_0.3_100_200_flip_cifar10.pkl'
median= open_file(data8)

data9= '../../Data/cifar10/flipping/table/trimmed_mean_0.3_1_0.3_100_200_flip_cifar10.pkl'
TM= open_file(data9)
...
plt.show
plt.savefig('../../Figures/edge/power point/cifar10_flip.png', bbox_inches='tight')
