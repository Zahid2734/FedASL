...
beta= .2
client_percent= .3
file_name = "../../Data/mnist/Dataset0.3_1_100_flip_mnist.pkl"
...
save_file_name= f'../../Data/mnist/flipping/FedSTD_0.3_1_{client_percent}_{num_client}_{num_epochs}_{alpha}_{beta}_flip_mnist.pkl'
