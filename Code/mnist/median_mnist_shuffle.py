...
from Code.algorithm.median_algo_mnist import median_algo
...
save_file_name= f'../../Data/mnist/shuffling/median_0.4_1_{client_percent}_{num_client}_{num_epochs}_shuffle_mnist.pkl'
