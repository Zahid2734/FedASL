...
beta= .2
client_percent= .3
file_name = "../../Data/mnist/Dataset0.4_1_100_shuffle_mnist.pkl"
...
save_file_name= f'../../Data/mnist/shuffling/FedSTD_0.4_1_{client_percent}_{num_client}_{num_epochs}_{alpha}_{beta}_shuffle_mnist.pkl'
