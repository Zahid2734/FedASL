...
plt.rcParams.update({'font.size': 30,'font.weight':'bold','pdf.fonttype':42})
...
men_means=[round(f1_cifar10_avg/5400,2)*100,round(f1_mnist_avg/5400,2)*100, round(f1_femnist_avg/75000,2)*100]
women_means=[round(f1_cifar10_tm/5400,2)*100,round(f1_mnist_tm/5400,2)*100, round(f1_femnist_tm/75000,2)*100]
...
plt.ylim(0, 60)
plt.legend(loc='upper left', ncol=1, fontsize=25, frameon=False, borderaxespad=0.02, handlelength=0.7,
...
plt.savefig('../../Figures/sigmetrix/computation_save.pdf', bbox_inches='tight')
