...
men_means=[round(f1_cifar10_avg/5100,3)*100,round(f1_mnist_avg/5100,2)*100, round(f1_femnist_avg/60000,3)*100]
women_means=[round(f1_cifar10_tm/5100,3)*100,round(f1_mnist_tm/5100,4)*100, round(f1_femnist_tm/60000,3)*100]
...
plt.savefig('../../Figures/sigmetrix/computation_save_sig.pdf', bbox_inches='tight')
