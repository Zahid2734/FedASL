...
plt.plot(np.array(FedAVG_1[0])*100, '-', c='green', linewidth=3.0, zorder=5, mfc='green', mec='green', mew=1, label='1 bad')
plt.plot(np.array(FedAVG_2[0])*100, '-', c='brown', linewidth=3.0, zorder=4, mfc='brown', mec='brown', mew=1,label='2 bad')
plt.plot(np.array(FedAVG_3[0])*100, '-', c='blue', linewidth=3.0, zorder=3,  mfc='blue', mec='blue', mew=1,label='3 bad')
plt.plot(np.array(FedAVG_4[0])*100, '-', c='orange', linewidth=3.0, zorder=2,  mfc='orange', mec='orange', mew=1,label='4 bad')
plt.plot(np.array(FedAVG_5[0])*100, '-', c='purple', linewidth=3.0, zorder=1,  mfc='purple', mec='purple', mew=1,label='5 bad')
...
plt.show
plt.savefig('../../Figures/sigmetrix/Sigmetrix_intro_fedavg_small.pdf', bbox_inches='tight')
