...
data10= '../../Data/Femnist/Noisy/trimmed_mean_plus_FedPA_0.3_1_3000_250_noise_Femnist_11.pkl'
...
plt.title('TM+FedSRC',weight='bold')
...
plt.show
plt.savefig('../../Figures/sigmetrix/good_bad_pass_femnist_tm_poster.png', bbox_inches='tight')
