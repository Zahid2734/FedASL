...
data5= '../../Data/mnist/shuffling/table/FedAVG_0.1_1_0.3_100_200_shuffle_mnist.pkl'
FedAVG= open_file(data5)


data7= '../../Data/mnist/shuffling/table/FedSTD_loss_0.1_1_0.3_100_200_1_0.2_shuffle_mnist.pkl'
FedSTD_loss= open_file(data7)

data8= '../../Data/mnist/shuffling/table/median_0.1_1_0.3_100_200_shuffle_mnist.pkl'
median= open_file(data8)

data9= '../../Data/mnist/shuffling/table/trimmed_mean_0.1_1_0.3_100_200_shuffle_mnist.pkl'
TM= open_file(data9)
