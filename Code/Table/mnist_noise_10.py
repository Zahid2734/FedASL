...
data5= '../../Data/mnist/noisy/table/FedAVG_0.1_1_0.3_100_200_noise_mnist.pkl'
FedAVG= open_file(data5)

data7= '../../Data/mnist/noisy/table/FedSTD_loss_0.1_1_0.3_100_200_0.9_0.2_noise_mnist.pkl'
FedSTD_loss= open_file(data7)

data8= '../../Data/mnist/noisy/table/median_0.1_1_0.3_100_200_noise_mnist.pkl'
median= open_file(data8)

data9= '../../Data/mnist/noisy/table/trimmed_mean_0.1_1_0.3_100_200_noise_mnist.pkl'
TM= open_file(data9)
