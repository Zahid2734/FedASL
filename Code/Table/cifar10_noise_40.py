...
data5= '../../Data/cifar10/noisy/table/FedAVG_0.4_1_0.3_100_200_noise_cifar10.pkl'
FedAVG= open_file(data5)

data7= '../../Data/cifar10/noisy/table/FedSTD_loss_0.4_1_0.3_100_200_0.9_0.2_noise_cifar10.pkl'
FedSTD_loss= open_file(data7)

data8= '../../Data/cifar10/noisy/table/median_0.4_1_0.3_100_200_noise_cifar10.pkl'
median= open_file(data8)

data9= '../../Data/cifar10/noisy/table/trimmed_mean_0.4_1_0.3_100_200_noise_cifar10.pkl'
TM= open_file(data9)
