...
data5= '../../Data/Femnist/Noisy/table/FedAVG_0.1_1_3000_250_noise_Femnist.pkl'
FedAVG= open_file(data5)


data7= '../../Data/Femnist/Noisy/table/FedSTD_loss_0.1_1_3000_250_0.7_0.2_noise_Femnist.pkl'
FedSTD_loss= open_file(data7)

data8= '../../Data/Femnist/Noisy/table/median_0.1_1_3000_250_noise_Femnist.pkl'
median= open_file(data8)

data9= '../../Data/Femnist/Noisy/table/trimmed_mean_0.1_1_3000_250_noise_Femnist.pkl'
TM= open_file(data9)
