...
data5= '../../Data/Femnist/flipping/table/FedAVG_0.4_1_3000_250_flip_Femnist.pkl'
FedAVG= open_file(data5)

data7= '../../Data/Femnist/flipping/table/FedSTD_loss_0.4_1_3000_250_0.1_0.01_flip_Femnist.pkl'
FedSTD_loss= open_file(data7)

data8= '../../Data/Femnist/flipping/table/median_0.4_1_3000_250_flip_Femnist.pkl'
median= open_file(data8)

data9= '../../Data/Femnist/flipping/table/trimmed_mean_0.4_1_3000_250_flip_Femnist.pkl'
TM= open_file(data9)
