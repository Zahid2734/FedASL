...
def FedSTD_algo_cifar10(comms_round, client_taken, clients_batched,x_test,y_test , client_percent, alpha, beta, previous_average):
    alpha= alpha
    beta= beta
    lr = 0.01
    ...
    for comm_round in range(comms_round):
        ...
        weighted_value, median, st_dev = weight_alpha_beta_median(accuracy_list,alpha, beta)
