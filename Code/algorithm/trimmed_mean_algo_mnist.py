...
from Code.utils.math_function import weight_scalling_factor,fed_avg_weight,scale_model_weights,sum_scaled_weights,weight_std_dev_median , median_algo_mnist, trimmed_mean_algo_mnist
import random
import math
import random
import os
...
def trimmed_mean_algo(comms_round, client_taken, clients_batched,x_test,y_test, client_percent, percent_trim):
    lr = 0.01
