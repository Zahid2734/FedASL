...
from Code.utils.math_function import weight_scalling_factor,fed_avg_weight,scale_model_weights,sum_scaled_weights,weight_std_dev_median, trimmed_mean_algo_cifar10,weight_alpha_beta_median
...
def tm_plus_FedPA_algo_cifar10(comms_round, client_taken, data ,x_test,y_test , client_percent, percent_trim):
    alpha= 1
    beta= .2
    lr = 0.01
