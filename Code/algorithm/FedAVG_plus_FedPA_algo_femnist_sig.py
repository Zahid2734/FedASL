...
def FedAVG_plus_FedPA_algo_femnist(comms_round, client_taken, data ,x_test,y_test , client_percent):
    alpha= 1
    beta= .2
    lr = 0.01
    ...
    for comm_round in range(comms_round):
        ...
        for i in range(len(randomlist)):
            ...
            if comm_round > 50:
                ...
                if post_accurcy - pre_accuracy < 2 * standard_dev and post_accurcy - pre_accuracy > 1 * standard_dev and (median - 1.5 * standard_dev) < pre_accuracy:
                    print('passed')
