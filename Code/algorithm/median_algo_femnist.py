...
from Code.utils.math_function import weight_scalling_factor,fed_avg_weight,scale_model_weights,sum_scaled_weights,weight_std_dev_median, median_algo_femnist
import random
import math
import random
import os
...
def median_algo(comms_round, client_taken, clients_batched,x_test,y_test, client_percent ):
    ...
    for comm_round in range(comms_round):
        ...
        weighted_value = median_algo_femnist(scaled_local_weight_list)
