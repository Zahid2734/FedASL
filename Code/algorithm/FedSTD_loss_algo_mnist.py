...
def FedSTD_algo_loss(comms_round, client_taken, clients_batched,x_test,y_test , client_percent, alpha, beta,previous_average):
    alpha= alpha
    beta= beta
    lr = 0.01
    ...
    for comm_round in range(comms_round):
        ...
        for i in range(len(randomlist)):
            ...
            # print('loss we report',history.history['loss'])
