...
file_name = "../../Data/Femnist/Dataset_shuffle_3000_0.3_1.pkl"
...
GLobal_accuracy,Client_accuracy,local_weight, taken_client = FedAVG_algo_Femnist(num_epochs, num_client, clients_batched,x_test,y_test, client_percent)
sample_list=[GLobal_accuracy,Client_accuracy, taken_client , bad_client, local_weight]

save_file_name= f'../../Data/Femnist/Shuffling/FedAVG_for_weight_shuffle_Femnist.pkl'
